<h4>Produk - Detail Timbang [Giling]</h4>
<hr>

  <div class="form-group">
      <label>No Transaksi</label>
      <input type="text" class="form-control" disabled placeholder="" value="<?php echo $row->cNomor_timbang ?>">
  </div>
  <div class="form-group">
      <label>Tanggal Transaksi</label>
      <input type="text" class="form-control" disabled placeholder="" value="<?php echo $row->tanggal_timbang ?>">
  </div>
   <div class="form-group">
