<table id="tabletimbang" class="table table-striped table-bordered tabletimbang" width="100%" cellspacing="0">
   <thead>
      <tr> 
  ...
  <tbody>
    <tr> 
        <td style="width:5%;text-align: center;"><span class="tabletimbang_numasd">1</span></td> 
        <td style="width:15%;">  
        ...
        <td style="width:10%;text-align: center;"><span onClick="del_row(this,'tabletimbang')" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="false"></span></span></td>
    </tr> 
  </tbody>
  <tfoot>
   <tr>
   ...
   <tr>
     <td colspan="6" align="left"> 
        <span onClick="add_row2('tabletimbang')" class="btn btn-primary"><span class="glyphicon glyphicon-plus" aria-hidden="false"> Detail</span> </span> 
